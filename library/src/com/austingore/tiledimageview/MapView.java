...
import com.austingore.tiledimageview.geom.Coordinate;
import com.austingore.tiledimageview.geom.Geolocator;
import com.austingore.tiledimageview.geom.XPoint;
import com.austingore.tiledimageview.hotspots.HotSpot;
import com.austingore.tiledimageview.layers.MarkerLayer;
...
import com.austingore.tiledimageview.zoom.ZoomSet;
...
//    has this actually been done? Where does it compute this?
...
mapView.addZoomLevel("level2/%col%-%row%.jpg");  // will be 125x125</pre>
	 ...
	 */
	public void addHotSpot(Rect r, OnClickListener l){

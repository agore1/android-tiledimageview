...
package com.example.MapViewDemoActivity;
...
//        mapView.addZoomLevel("tiles/alexis_25_%col%_%row%.jpg", "downsamples/alexis.jpg");
        mapView.addZoomLevel(1109, 2048,"tiles/alexis_100_%col%_%row%.jpg", "downsamples/alexis.jpg");
        mapView.addZoomLevel(683, 1024,"tiles/alexis_50_%col%_%row%.jpg", "downsamples/alexis.jpg");
        mapView.addZoomLevel(341, 512,"tiles/alexis_25_%col%_%row%.jpg", "downsamples/alexis.jpg");
